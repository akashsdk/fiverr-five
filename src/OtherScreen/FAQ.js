    ...
    <div className="body">
      ...
      <div className="box">
        <TextCart
          headerText="FAQ"
          bodyText="
        Q: Is CinemarooBD completely free to use?
        <br/> 
        A: Yes, CinemarooBD is
        ...
        <br />
        <br />
        Q: Do I need to create an account to watch content on CinemarooBD? 
        <br/> 
        A: No, you can browse and watch content on CinemarooBD without creating
        an account. However, creating an account allows you to personalize
        your experience and access additional features.
        <br />
        <br />
        Q: Is the content on CinemarooBD legal?
        <br/> 
         A: Yes, all content available
        ...
        <br />
        <br />
        Q: Can I download movies or shows for offline viewing?
        <br/> 
         A: Currently,
        ...
        <br />
        <br />
        Q: How frequently is new content added to CinemarooBD?
        <br/> 
         A: We strive to
        ...
        <br />
        <br />
        Q: How can I report a technical issue or suggest a feature?
        <br/> 
         A: If you
        ...
        <br />
        <br />
        Q: Is CinemarooBD available on mobile devices?
        <br/> 
         A: Yes, CinemarooBD is
        ...
        <br />
        <br />
        Q: How can I contact CinemarooBD for further assistance?
        <br/> 
         A: For any further inquiries or assistance, please contact us at
